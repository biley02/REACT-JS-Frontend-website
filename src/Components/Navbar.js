							...
							>
								<ul className="navbar-nav ml-auto">
									<li className="nav-item active">
										<NavLink exact activeStyle={style} className="nav-link" to="/">
									...
									<li className="nav-item">
									  ...
									  {' '}
									<li className="nav-item">
										<NavLink exact activeStyle={style} className="nav-link" to="/service">
											Services  {' '}
										</NavLink>{' '}
										  {' '}
									</li>{' '}
									  {' '}
									<li className="nav-item">
										<NavLink exact activeStyle={style} className="nav-link" to="/contact">
											Contact  {' '}
										</NavLink>{' '}
										  {' '}
									</li>{' '}
